...
// DTO trả JSON response cho REST API.
public class TransferRestResponse {
    private String transactionId; // Mã giao dịch server sinh.
    private String requestId; // Mã request client gửi, trả lại để đối chiếu.
