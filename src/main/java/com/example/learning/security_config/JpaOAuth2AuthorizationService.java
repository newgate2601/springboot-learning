...
//
//
//    // https://chatgpt.com/c/66eea049-28bc-8010-ad2e-a84f56388bf5
...
//
//        objectMapper.addMixIn(OAuth2ClientAuthenticationToken.class, Test.UserMixin.class);
...
//        Optional<AuthorizationEntity> result = this.authorizationRepository.findById(id);
